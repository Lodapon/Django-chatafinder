...
def tarot_chat(request):
    ...
    if request.method == 'POST':
        ...
        if user_input:
            ...
            ไม่ต้องอธิบายถึงความหมายของไพ่แต่ละใบ แต่ให้เข้าประเด็นแล้วเริ่มทำนายได้เลย

            สามารถถามถึงความกังวลหรือคำถามที่ผู้ใช้อยากรู้ได้

            ถ้าคิดว่าไพ่ 10 ใบที่จับมาตอนแรกไม่เพียงพอสำหรับคำถามต่อๆ มา สามารถขอให้ผู้ใช้จับไพ่เพิ่มอีก 3 ใบได้

            **อย่าจับไพ่ทันที** — ให้พิจารณาความเหมาะสมของคำถามก่อน
